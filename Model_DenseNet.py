...
def Model_DenseNet(train_data, train_target, test_data, test_target):
    IMG_SIZE = [32, 32, 3]
    ...
    model.compile(optimizer='Adam', loss='categorical_crossentropy', metrics=['accuracy'], Activation='Relu')
    model.fit(train_data, train_target, steps_per_epoch=400, epochs=150, batch_size=64)
    pred = model.predict(test_data)
    Eval = evaluation(pred, test_target.ravel())
    return Eval, pred
