...
def MobileNet(
    ...
    **kwargs,
    ...
    x1 = _depthwise_conv_block(x, 512, alpha, depth_multiplier, block_id=7)
    x2 = _depthwise_conv_block(x1, 512, alpha, depth_multiplier, block_id=8)
    x3 = _depthwise_conv_block(x2, 512, alpha, depth_multiplier, block_id=9)

    x = _depthwise_conv_block(x3, 512, alpha, depth_multiplier, block_id=10)
